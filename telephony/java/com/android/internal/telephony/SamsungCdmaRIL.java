...
public class SamsungCdmaRIL extends RIL implements CommandsInterface {
...
public SamsungCdmaRIL(Context context, int networkMode, int cdmaSubscription) {
...
@Override
 public void
    ...
    responseNetworkType(Parcel p) {
        ...
        // Seems like MSM7627-based devices aren't reporting CDMA network type correctly, they report Phone.NT_MODE_GLOBAL instead
        // This causes our devices to think that they're GSM devices, causing serious issues.
        // This overrides this issue on those devices
        /*if (mIsSamsungCdma && mIsSamsungCdmaFakeNetType && response[0] == Phone.NT_MODE_GLOBAL) {
            Log.d(LOG_TAG, "Overriding network type response from global to CDMA (prl)");
...
//    public void getPreferredNetworkType(Message response) {
         ...
         * causes the system to not recognize the phone as a CDMA device.
         *
         * As such, we will override the behavior here, and lie to the system.
